...
| --- | :-: | :-: | :-: |  :-: | :-: | :-: | :-: | :-: |
| playtime | 50 | 40 | 60 | none | 20 | 70 | 100 | 80 |
...
2. **bayesian hyper parameter fitting을 활용하자.**
    - 위에서 모델 성능이 중요하진 않다고 했지만 그건 발표 기회가 주어지는 경우에 해당되고, 일단 30등 안에 들어야 발표 기회가 주어지기 때문에 기본적으로 어느 정도의 성능은 나와줘야 합니다. 저희는 이전까지 bayesian hyper parameter fitting을 잘 알지 못했는데, 대회 발표장에 가서 다른 팀을 통해 해당 방식의 강력함을 확인하고 굉장히 놀랐습니다. 대회 참가팀의 능력치가 매년 올라가는 것은 확정적이기 때문에, 앞으로의 대회에서는 해당 방법이 baseline이 되지 않을까 생각해봅니다.
3. **시각화가 중요하다**
